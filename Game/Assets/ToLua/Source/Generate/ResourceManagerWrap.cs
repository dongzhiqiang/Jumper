...
public class ResourceManagerWrap
{
	...
	static int LoadPrefab(IntPtr L)
	{
		try
		{
			...
			if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(ResourceManager), typeof(string), typeof(string[]), typeof(LuaInterface.LuaFunction)))
			{
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(ResourceManager), typeof(string), typeof(string[]), typeof(System.Action<UnityEngine.Object[]>)))
			{
				ResourceManager obj = (ResourceManager)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				string[] arg1 = ToLua.CheckStringArray(L, 3);
